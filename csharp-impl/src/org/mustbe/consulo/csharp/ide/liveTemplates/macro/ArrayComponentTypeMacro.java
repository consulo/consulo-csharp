 ...
 * @since 30.12.14
 */
public class ArrayComponentTypeMacro extends Macro
{
	@Override
	public String getName()
	{
		return "csharpComponentTypeOf";
	}

	@Override
	public String getPresentableName()
	{
		return "csharpComponentTypeOf(ARRAY)";
	}
	...
	public Result calculateResult(@NotNull Expression[] params, ExpressionContext context)
	{
		...
		DotNetTypeRef typeRef = expression.toTypeRef(false);
		if(typeRef instanceof DotNetArrayTypeRef)
		{
			return new TextResult(CSharpTypeRefPresentationUtil.buildShortText(((DotNetArrayTypeRef) typeRef).getInnerTypeRef(), place));
		}
		return null;
	}
}
