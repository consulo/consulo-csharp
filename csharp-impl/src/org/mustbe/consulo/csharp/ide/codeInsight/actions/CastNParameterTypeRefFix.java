 ...
 * @since 30.12.14
 */
public class CastNParameterTypeRefFix extends BaseIntentionAction
{
	@NotNull
	...
	public CastNParameterTypeRefFix(@NotNull DotNetExpression expression, @NotNull DotNetTypeRef expectedTypeRef, @NotNull String parameterName)
	{
