...
public interface CSharpElements {
    ...
    IElementType NAMESPACE_STATEMENT = CSharpStubElements.NAMESPACE_STATEMENT;
    ...
    IElementType FIXED_SIZE_BUFFER_INITIALIZER = new CompositeElementTypeAsPsiFactory("FIXED_SIZE_BUFFER_INITIALIZER", CSharpLanguage.INSTANCE, CSharpFixedSizeBufferInitializerImpl::new);
