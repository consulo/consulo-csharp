...
public class CSharpNamespaceAsElementImpl extends IndexBasedDotNetNamespaceAsElement
{
			...
			@NotNull final PsiElement place)
	{
		...
		return StubIndex.getInstance().processElements(CSharpIndexKeys.USING_LIST_INDEX, DotNetNamespaceUtil.getIndexableNamespace(myQName), myProject,
				searchScope, CSharpUsingListImpl.class, new Processor<CSharpUsingListImpl>()
		{
			@Override
