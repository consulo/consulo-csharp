 ...
 * @since 15.01.14
 */
public class CSharpStubPointerTypeInfo extends CSharpStubTypeInfo
{
	private final CSharpStubTypeInfo myInnerType;

	public CSharpStubPointerTypeInfo(CSharpStubTypeInfo innerType)
	{
		myInnerType = innerType;
	}

	public CSharpStubPointerTypeInfo(StubInputStream inputStream) throws IOException
	{
